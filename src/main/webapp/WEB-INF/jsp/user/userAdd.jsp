                    ...
                    <div class="layui-card-body">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <select name="employid" lay-filter="required" id="employid">
...
<script>
    layui.use('form', function () {
        ...
        //动态加载员工信息
        $.ajax({
            url: '<%=contextPath%>/employee/showemplist',
            type: 'POST',
            dataType: 'json',
            success: function (result) {
                ...
                for (var i = 0; i < list.length; i++) {
                    //追加option
                    $("#employid").append("<option value=" + list[i].id + ">" +list[i].id+ list[i].name + "</option>");
                    //渲染刷新
                    form.render('select');
                }
            },
